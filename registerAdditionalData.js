...
const specialists_1 = require("./AdditionalData/specialists");
const worked_by_1 = require("./AdditionalData/worked-by");
AdditionalDataRegistry_1.instance.register(...(0, cities_1.default)(), ...(0, specialists_1.default)(), ...(0, worked_by_1.default)());
