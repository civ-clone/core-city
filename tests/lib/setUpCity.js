...
const setUpCity = async (name = 'city', ruleRegistry = RuleRegistry_1.instance) => new City_1.default(new Player_1.default(), await (0, buildWorld_1.generateTile)(), name, ruleRegistry);
