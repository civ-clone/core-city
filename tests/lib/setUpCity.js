...
const setUpCity = async (name = 'city', ruleRegistry = RuleRegistry_1.instance, workedTileRegistry = WorkedTileRegistry_1.instance) => new City_1.default(new Player_1.default(ruleRegistry), await (0, buildWorld_1.generateTile)(ruleRegistry), name, ruleRegistry, workedTileRegistry);
